...
! GLOBAL DATA
    ...
    USE FLGCOM_DAT, ONLY: REXFLG !  T = implement Rayleigh extinction
...
! EXECUTABLE CODE -------------------------------------------------------------
!
! If modelling Rayleigh extinction, set up 'air' as the first absorbing species
  IF ( REXFLG ) CALL ADDGAS ( IDXAIR ) 
!
  DO
